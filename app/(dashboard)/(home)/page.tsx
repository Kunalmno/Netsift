...
import CreditUsageChart from "../billing/_components/creditConsumedChart";
    ...
    <div className="flex flex-1 flex-col h-full">
      <div className="flex justify-between">
        ...
        <div className="w-[140px]">
          <Suspense fallback={<Skeleton className="w-full h-[40px]" />}>
...
async function CreditsUsageInPeriod({
  ...
  return (
    <CreditUsageChart
      ...
      description="Daily credit cosumed in selected period"
    />
  );
}
