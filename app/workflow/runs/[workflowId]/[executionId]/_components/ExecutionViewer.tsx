...
import { CalendarIcon, CircleDashedIcon, ClockIcon, CoinsIcon, Icon, Loader2Icon, LucideIcon, NotebookIcon, WorkflowIcon } from "lucide-react";
        ...
        <aside className="w-[400px] min-w-[400px] max-w-[400px] border-r-2 border-separate flex flex-grow flex-col overflow-hidden">
            <div className="flex justify-center items-center py-2 px-4">
                <div className="text-muted-foreground flex items-center gap-2">
                   <NotebookIcon size={20} className="stroke-muted-foreground/80"/>
            ...
            <TableBody>
                {logs.map(log => (
                    <TableRow key={log.id} className="text-muted-foreground">
                        <TableCell width={190} className="text-xs text-mutes-foreground p-[2px] pl-4">{log.timestamp.toISOString()}</TableCell>
                        <TableCell 
                            width={80} 
